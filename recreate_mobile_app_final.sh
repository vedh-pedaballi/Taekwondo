...
# --- This script will completely reset and run your mobile app using full paths ---

# Using the full path to the ionic command to bypass any shell issues
IONIC_CMD="/usr/local/bin/ionic"
...
$IONIC_CMD start tornado-sports-app tabs --type=angular --no-interactive --git=false
